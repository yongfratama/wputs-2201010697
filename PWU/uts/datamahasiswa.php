    ...
    if(isset($_POST["act"])){
        ...
        switch ($act){
            case "store":
                ...
                if($pass1 == $pass2){
                    $nama = $_POST["txNAMA"];
                    $jurusan = $_POST["txEMAIL"];
                    $user = $_POST["txUSER"];
                    $iduser = md5($jurusan);
                    $sql = "INSERT INTO tbmahasiswa(nama, jurusan, username, passkey, iduser) VALUES('$nama', '$jurusan', '$user', '$pass1', '$iduser');";
            ...
            case "update":
                ...
                if($pass1 == $pass2){
                    ...
                    $user = $_POST["txUSER"];
                    $iduser = $_POST["iduser"];
                    $sql = "UPDATE tbmahasiswa SET nama='$nama', jurusan='$jurusan', username='$user', passkey='$pass1' WHERE iduser='$iduser';";
                    $hasil = mysqli_query($cnn, $sql);
                    if($hasil){
                        $footer = "<script>
                        Swal.fire({
