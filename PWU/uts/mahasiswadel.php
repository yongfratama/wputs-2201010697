<?php
    $iduser = $_GET["p1"];
    $sql = "SELECT tu.nama, tu.jurusan, tu.username FROM tbmahasiswa tu WHERE tu.iduser='$iduser';";
...
<form method="POST" action="datauser.php">
    ...
    <div class="form-floating mb-3">
        <input type="text" name="txEMAIL" class="form-control" id="floatingInput" placeholder="Alamat Email" value="<?=$h["jurusan"]?>">
